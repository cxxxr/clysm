...
### Completed Features (017-045, 001-ansi-array-primitives, 001-ansi-array-ops, 001-ansi-char-functions, 001-ansi-string-trim, 001-defstruct-wasm-compile, 002-numeric-functions, 001-numeric-format, 001-arithmetic-primitives, 002-primitive-dispatch-table, 001-equality-type-dispatch, 001-string-runtime-migration, 001-numeric-runtime-migration)

| Feature | Description |
|---------|-------------|
| 001-numeric-runtime-migration | Migrated numeric functions ([parse-integer](resources/HyperSpec/Body/f_parse_.htm), [write-to-string](resources/HyperSpec/Body/f_wr_to_.htm), [rationalize](resources/HyperSpec/Body/f_ration.htm), [signum](resources/HyperSpec/Body/f_signum.htm), [phase](resources/HyperSpec/Body/f_phase.htm)) from inline Wasm codegen to Lisp runtime library (numeric-runtime.lisp). 5 functions registered in *runtime-function-table*. ANSI keyword arguments (:start, :end, :radix, :junk-allowed, :base). Type-correct signum (returns same type as input). Continued fraction algorithm for rationalize. 33 unit tests. Stage 1 compiles, Wasm validates. |
...
| 001-string-runtime-migration | Migrated string functions ([char](resources/HyperSpec/Body/f_char_.htm), [string-trim](resources/HyperSpec/Body/f_stg_tr.htm), [string-capitalize](resources/HyperSpec/Body/f_stg_up.htm), [string-equal](resources/HyperSpec/Body/f_stgeq_.htm) families) from inline Wasm codegen to Lisp runtime library (string-runtime.lisp). 14 functions registered in *runtime-function-table*. UTF-8 support, ANSI :start/:end keywords. 361 lines of maintainable Lisp. Stage 1 compiles, Wasm validates. |
...
- Common Lisp (SBCL 2.4+) for host compiler, WasmGC for target + alexandria, babel (UTF-8), existing runtime dispatch infrastructure (001-string-runtime-migration)
- Common Lisp (SBCL 2.4+) for host compiler, WasmGC for target runtime + alexandria, babel (UTF-8), existing clysm compiler infrastructure, string-runtime.lisp (UTF-8 helpers) (001-sequence-array-runtime)

## Recent Changes
- 001-sequence-array-runtime: Migrated sequence functions ([subseq](resources/HyperSpec/Body/f_subseq.htm), [copy-seq](resources/HyperSpec/Body/f_cp_seq.htm), [adjust-array](resources/HyperSpec/Body/f_adjust.htm)) from inline Wasm codegen to Lisp runtime library. Runtime library (sequence-runtime.lisp): 171 lines added. func-section.lisp reduced by 350 lines (removed compile-subseq, compile-copy-seq, compile-adjust-array). UTF-8 character-position indices for string subseq (reuses utf8-continuation-byte-p, decode-utf8-char helpers). All 3 functions registered in *runtime-function-table* via register-sequence-runtime-functions. 1D arrays only for adjust-array MVP. Unit tests in tests/unit/sequence-array-runtime-test.lisp. Stage 1 compiles, Wasm validates.
- 001-string-runtime-migration: Migrated string functions ([char](resources/HyperSpec/Body/f_char_.htm), [schar](resources/HyperSpec/Body/f_char_.htm), [string-trim](resources/HyperSpec/Body/f_stg_tr.htm), [string-left-trim](resources/HyperSpec/Body/f_stg_tr.htm), [string-right-trim](resources/HyperSpec/Body/f_stg_tr.htm), [string-capitalize](resources/HyperSpec/Body/f_stg_up.htm), [nstring-capitalize](resources/HyperSpec/Body/f_stg_up.htm), [string-equal](resources/HyperSpec/Body/f_stgeq_.htm), [string-not-equal](resources/HyperSpec/Body/f_stgeq_.htm), [string-lessp](resources/HyperSpec/Body/f_stgeq_.htm), [string-greaterp](resources/HyperSpec/Body/f_stgeq_.htm), [string-not-lessp](resources/HyperSpec/Body/f_stgeq_.htm), [string-not-greaterp](resources/HyperSpec/Body/f_stgeq_.htm) - 14 functions) from inline Wasm codegen to Lisp runtime library. Runtime library (string-runtime.lisp): 361 lines. UTF-8 support with utf8-continuation-byte-p, decode-utf8-char helpers. ANSI keyword arguments (:start, :end, :start1, :end1, :start2, :end2). All functions registered in *runtime-function-table* via register-string-runtime-functions. Unit tests in tests/unit/string-runtime-test.lisp. Stage 1 compiles, Wasm validates.
