...
(defun compile-primitive-call (op args env)
  ...
  (let ((env (env-with-non-tail env))
    ...
    ;; char/schar: now via *runtime-function-table* (001-string-runtime-migration)
    ...
    (string<= (compile-string<= args env))
    (string>= (compile-string>= args env))
    ;; Case-insensitive string comparison: now via *runtime-function-table* (001-string-runtime-migration)
    ...
    ;; string-capitalize: now via *runtime-function-table* (001-string-runtime-migration)
    ;; String trimming: now via *runtime-function-table* (001-string-runtime-migration)
    ...
    ;; nstring-capitalize: now via *runtime-function-table* (001-string-runtime-migration)
...
;;; Numeric Tower Type Dispatch (T013-T015) - REMOVED (unused infrastructure code)
...
;;; emit-string-comparison-case-sensitive: REMOVED (superseded by newer string comparison logic)
;;; emit-string-comparison-case-insensitive: REMOVED (superseded by newer string comparison logic)
...
;;; compile-signum: now via *runtime-function-table* (001-numeric-runtime-migration)
...
;;; compile-phase: now via *runtime-function-table* (001-numeric-runtime-migration)
...
;;; compile-rationalize: now via *runtime-function-table* (001-numeric-runtime-migration)
;;; compile-write-to-string: now via *runtime-function-table* (001-numeric-runtime-migration)
;;; compile-parse-integer: now via *runtime-function-table* (001-numeric-runtime-migration)
...
;;; compile-string-char: now via *runtime-function-table* (001-string-runtime-migration)
...
;;; Case-insensitive string comparison: now via *runtime-function-table* (001-string-runtime-migration)
;;; compile-string-equal, compile-string-lessp, compile-string-greaterp,
;;; compile-string-not-lessp, compile-string-not-greaterp, compile-string-not-equal removed
...
;;; compile-string-compare-at-end: REMOVED (superseded by v2 version)
...
;;; compile-string-compare-at-diff: REMOVED (superseded by v2 version)
...
;;; compile-string-capitalize: now via *runtime-function-table* (001-string-runtime-migration)
...
;;; %generate-in-char-bag-check: REMOVED (orphaned helper function never integrated)
...
;;; ------------------------------------------------------------
;;; nstring-upcase, nstring-downcase (destructive)
;;; nstring-capitalize and string-*-trim now via *runtime-function-table* (001-string-runtime-migration)
