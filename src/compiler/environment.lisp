...
;;; Self-hosting Mode Flag
;;;
;;; When *self-hosting-mode* is T, we skip SBCL-specific code paths
;;; and use only portable Common Lisp constructs.
...
(defstruct compile-env
  ...
  (block-depth 0 :type integer))

;; Note: copy-compile-env is automatically generated by defstruct in SBCL.
;; When self-compiling, our defstruct implementation will need to generate it
;; or we'll need to define it manually in the compiled output.
